...
1. Post at minimum once per week — Google slightly favours profiles with regular post activity
2. Use 'What's New' posts for general updates
3. Use 'Event' posts for anything time-bound (classes, sales, seasonal offers)
4. Use 'Offer' posts for discounts — these display with a special badge in search results
5. Keep posts concise (150–300 words) and include a call-to-action
6. Add a photo to every post — posts with images get 94% more views
...
- [The Ultimate Guide to Google Business Profile Optimization Tools](/blog/google-business-profile-optimization-tool)
