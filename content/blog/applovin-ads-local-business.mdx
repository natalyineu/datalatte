...
<StatRow
  ...
  labels="Daily active users in AppLovin network|Daily active users in AppLovin network|Daily active users in AppLovin network|Daily active users in AppLovin network"
