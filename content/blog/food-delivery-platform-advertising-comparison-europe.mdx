...
Even the most data-savvy local business owners slip up when jumping into food delivery advertising. I’ve seen coffee shop owners in Paris throw €500 at a Glovo campaign without adjusting their menu photos, and bakery owners in Berlin wonder why Wolt ads didn’t bring a single extra order. These mistakes aren’t just frustrating—they cost real money. Let me walk you through the five most common pitfalls I’ve observed across Europe, along with specific, actionable fixes that have worked for our clients at DataLatte.pro.

### Mistake #1: Treating All Platforms the Same – Ignoring Audience Demographics

**What happens:** You copy-paste the same ad creative and targeting settings from Uber Eats to Wolt, assuming the same audience will respond. But the data tells a different story. In the UK, Uber Eats skews 18–34, with 62% of orders coming from urban professionals who order dinner after 7 p.m. Wolt in Germany has a slightly older demographic (25–44) and sees peak lunch orders (11 a.m.–2 p.m.) for office workers. Glovo in Spain has a high concentration of late-night munchies orders (10 p.m.–1 a.m.) among students and young freelancers. If you’re a sandwich shop owner in Madrid advertising a healthy breakfast bowl at 11 p.m., you’re burning budget.

**The fix (with numbers):** Before launching any campaign, pull the platform’s own audience insights (most provide a free demographic report when you set up a business account). Then, manually adjust your ad schedule and creative. For example, a café in Barcelona we worked with saw a 34% increase in conversion rate after shifting their Glovo ad spend from 9 a.m.–12 p.m. (when Glovo’s audience is ordering lunch from other categories) to 5 p.m.–9 p.m. (when coffee and pastries are popular as afternoon pick-me-ups). Use platform-specific ad scheduling tools: Uber Eats lets you set “day-parting” for sponsored listings, while Wolt’s “Boost” campaigns allow you to choose hours. Test one platform at a time for the first two weeks, and track cost-per-order by hour. If your cost-per-order is above €8 on a platform where your average basket is €12, you’re bleeding money.

### Mistake #2: Neglecting Menu Photos and Descriptions – The “Digital First Impression” Fail

**What happens:** You upload a blurry photo of your lasagna taken with a phone camera in bad lighting. Or worse, you don’t upload any photo at all. Research from Deliveroo’s own merchant portal shows that listings with at least three high-quality photos generate 2.5 times more clicks than those with none. Yet I regularly see Italian trattorias in Milan using stock photos of pasta that don’t match their actual dishes. Customers who order and receive something that looks different will leave a negative review—and the platform’s algorithm punishes you by lowering your visibility.

**The fix (with measurements):** Invest in a simple photo setup: a neutral background, natural daylight, and a smartphone with a decent camera. If you can’t hire a pro, use the free photo-editing tool on your platform’s dashboard (Uber Eats offers a “professional photo service” for a one-time fee of €29 in some markets—absolutely worth it). For each menu item, write a description that includes three key elements: the main ingredient, a texture or flavor note, and a serving suggestion. Example: “Our classic Italian Margherita pizza – San Marzano tomatoes, fresh mozzarella, basil on a thin, crispy crust. Best enjoyed warm. Serves one.” Avoid generic phrases like “delicious” or “tasty.” We helped a small chain of bakeries in Amsterdam rewrite their menu descriptions using action verbs (“baked fresh every morning,” “hand-rolled,” “topped with local Gouda”), and their click-through rate from the platform’s search results jumped from 4.2% to 9.1% in three weeks. That’s a 116% improvement for zero extra ad spend.

### Mistake #3: “Set It and Forget It” – Not Monitoring Campaign Performance Daily

**What happens:** You launch a Glovo ad campaign with a budget of €200, set it to auto-pilot, and check back after a month. You discover you spent €180 on ads that generated only 12 orders—a cost-per-order of €15, while your average profit per order is €4. You’re losing €11 every time someone orders. This is incredibly common. Food delivery ad platforms operate on real-time auctions. If you don’t tweak bids, adjust targeting, or pause underperforming ads, you’re at the mercy of competitors who may be bidding aggressively during peak hours.

**The fix (with daily actions):** Dedicate 10 minutes each morning to review three key metrics on the platform’s dashboard: cost-per-order (CPO), impression share, and conversion rate. If CPO exceeds 70% of your average profit per order, pause the campaign immediately. Then adjust your bid strategy—most platforms let you switch from “automatic bidding” (where the platform spends to get as many orders as possible) to “manual bidding” (where you set a max cost-per-click or cost-per-order). For a café in Lisbon, we set a manual max CPO of €6 on Uber Eats, and turned off ads during hours when that CPO was consistently exceeded. Their ad spend dropped by 41%, but orders only fell by 12%, so their overall profitability increased by 33%. Also, use the platform’s “suggested bid” range—for example, Wolt shows a recommended bid between €0.50 and €1.50 per impression. Start at the lower end, then increase by €0.10 every three days if you’re not getting enough impressions. Track daily.

### Mistake #4: Overlooking Commission and Hidden Fees – The 30% Surprise

**What happens:** You sign up for a food delivery platform, excited by the promise of thousands of new customers. Then your first statement arrives, and you realize you’re paying 30–35% commission on every order—plus a delivery fee, a marketing fee, and sometimes even a “lead generation” fee. For a small takeaway shop with thin margins, that can wipe out any profit. In France, Deliveroo’s standard commission for independent restaurants ranges from 25% to 30%, and they recently introduced a “Priority” placement fee of an extra 5%. Glovo charges between 20% and 35% depending on your city and contract. If you’re not calculating your net profit per order after all fees, you’re flying blind.

**The fix (with dollar amounts):** Before committing to any platform, request a detailed fee breakdown in writing. Then calculate your break-even point. Suppose your average order value is €18, your food cost is €6, your labor and overhead is €4, and the platform takes 30% (€5.40) plus a €1.50 delivery fee you’re responsible for. Your net profit per order is €18 – €6 – €4 – €5.40 – €1.50 = €1.10. That’s a 6% margin. If you run ads on top of that, you could easily go negative. Negotiate—yes, you can negotiate! Small businesses with solid foot traffic or repeat orders can often get a reduced commission for the first 90 days. We helped a pizza place in Rome renegotiate with Uber Eats from 30% to 22% by showing them the volume of orders they brought from their own Google Ads campaign (tracked via unique promo codes). Also, consider using the platform’s “pickup only” option if delivery fees are too high—many platforms (like Wolt) allow you to offer in-store pickup with a lower commission (often 15–18%). If your margin is still too thin, prioritize platforms with lower typical commissions: in Germany, Wolt often charges 20–25%, compared to Lieferando’s 30%.

### Mistake #5: Not Integrating Delivery Ads with Your Own Marketing Efforts

**What happens:** You run a Facebook ad driving traffic to your website, a Google Ads campaign for “best coffee near me,” and a separate Deliveroo campaign—all in silos. You have no way of knowing which customer came from which channel. You might be double-paying for the same customer (they see your Google ad, then later order via Deliveroo because it’s more convenient). Worse, you’re not building a direct relationship with those customers; all the data and loyalty stays with the delivery platform.

**The fix (with specific steps):** Use unique promo codes for each platform. For example, create a code “WELT10” for Wolt, “UBER10” for Uber Eats, and “GOOGLE10” for your own website orders. Track the redemption rate in your POS system. Then, in your Google Ads campaigns, add a remarketing pixel that can also fire when someone visits your menu on the delivery platform (many platforms allow you to embed a tracking pixel via their merchant portal). At DataLatte.pro, we set up a system for a bagel shop in London: they ran a Google Ads campaign with a £5-off coupon for direct orders, and simultaneously ran a Deliveroo campaign with a “free drink with any bagel” offer. By analyzing which channel generated the highest customer lifetime value (CLV) over 90 days, they discovered that directly acquired customers spent 2.3 times more in repeat orders than delivery platform customers. They shifted 40% of their ad budget from Deliveroo to Google Ads, using the delivery platform only for awareness, and saw overall profit increase by 18% in two months.
