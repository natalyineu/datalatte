...
<StepPlan
  steps="Set up Google Business Profile as a service area business — verify with video|Create a simple website (Squarespace or Wix) with homepage, services, about, and contact pages|List on Rover, Pawshake, and Tailster — these aggregate traffic you'd otherwise miss|Create a Facebook Business Page (many UK dog owners are over 35 and still use Facebook heavily)|Ask every client for a Google review — the timing is after a particularly good walk when they've seen your update photos|Join local Facebook community groups (not as a business, as a member — become the person who genuinely helps with dog questions)"
  title="Dog Walker Online Presence Setup — UK"
/>
