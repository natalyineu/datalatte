...
<StatRow values="75%|35%|40%|25%" labels="Hair Salons with Google Business Profile|Hair Salons with Google Business Profile|Hair Salons with Google Business Profile|Hair Salons with Google Business Profile" subs="active|inactive|incomplete|optimal" trends="up|neutral|down|up"/>
...
If that sounds like something you'd rather hand off, [Book a free consultation](/free-audit). I'll take a look at your profile, tell you exactly what's wrong, and whether we're a good fit to fix it. No pitch, no fluff, just the same honest assessment I'd give a client paying me five figures.
