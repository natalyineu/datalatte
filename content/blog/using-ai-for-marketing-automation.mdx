...
<StatRow values="70%|25%|50%|30" labels="Businesses using marketing automation|Marketers struggling with data analysis|Companies leveraging AI in marketing|Time spent on marketing automation" subs="Source: HubSpot|Source: HubSpot|Source: HubSpot|Source: HubSpot" trends="up|down|up|neutral" />
