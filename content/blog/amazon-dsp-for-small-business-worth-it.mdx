...
Even when local businesses find a path to Amazon DSP—through managed services, agency partnerships, or lower-funnel retargeting—they often stumble in ways that burn budget and yield disappointing results. Here are the five mistakes I see most often, along with specific fixes that actually work.

### Mistake #1: Treating Amazon DSP Like a Standard Social Media Ad

The most common error is confusing Amazon DSP with Facebook or Instagram ads. Business owners expect to see immediate engagement, comments, and shares. When they don't, they panic and pull the plug.

**The reality:** Amazon DSP is not a social platform. It's a demand-generation and retargeting tool built on purchase intent data. Your ads will appear across news sites, streaming platforms, and third-party apps—places where people are consuming content, not scrolling a feed. The goal isn't engagement; it's influence at the moment of consideration.

**The fix:** Set entirely different success metrics from the start. For upper-funnel campaigns (awareness), measure lift in brand searches on Amazon and assisted conversions. For lower-funnel campaigns (retargeting), measure ROAS (Return on Ad Spend) over a 7-to-14-day window—not 24 hours. If you're used to seeing social ad engagement rates of 2–5%, prepare for click-through rates closer to 0.3–0.8% on display. That's normal. What matters is whether those clicks convert.

**Real example:** A pet supply store in Austin ran a $3,000/month Amazon DSP retargeting campaign through an agency. Their click-through rate was 0.4%—below their Facebook benchmark. But their ROAS was 4.2x, compared to 1.8x on social. The difference? DSP reached people who had already viewed a product on Amazon and were just one reminder away from buying.

### Mistake #2: Ignoring the Creative Requirements

Local business owners often submit the same square image or 15-second video they use for Instagram Stories. Amazon DSP has strict technical requirements that vary by placement type, and ignoring them leads to rejected ads, poor rendering, or wasted spend on placements that don't fit.

**Common creative pitfalls:**
- Using a 1:1 aspect ratio for a 16:9 video placement on Fire TV
- Submitting static images without the required 15KB file size limit for certain display placements
- Forgetting to include the mandatory Amazon logo or "Available on Amazon" badge
- Creating video ads that don't include captions (critical for sound-off viewing on mobile and connected TV)

**The fix:** Build a creative checklist before you launch. Your agency or managed service provider should give you a specs sheet—if they don't, ask for one. The key Amazon DSP placements and their requirements are:

| Placement | Recommended Format | Aspect Ratio | Max File Size |
|-----------|-------------------|--------------|---------------|
| Amazon-owned display | Static image or GIF | 300x250, 728x90 | 40KB |
| Third-party display | Static image or HTML5 | Varies by publisher | 150KB |
| Fire TV | Video (MP4) | 16:9 (1920x1080) | 50MB |
| Twitch | Video or static | 16:9 or 1:1 | 10MB |

Invest in a single set of creative assets designed specifically for DSP—not repurposed from other channels. One good video ad for connected TV and three display sizes (300x250, 728x90, 160x600) will cover 90% of your placements.

### Mistake #3: Targeting Too Broadly (or Too Narrowly)

I see two extremes. Some business owners select every possible audience segment because they want to "reach everyone." Others hyper-target to a single product category, leaving their campaign starved for impressions.

**Too broad:** A coffee roaster in Seattle targets "snacks and beverages" shoppers—that's millions of people who buy everything from granola bars to energy drinks. Their ad shows up next to articles about gluten-free diets, reaching people who have zero interest in single-origin beans.

**Too narrow:** The same roaster targets only "people who viewed my specific Ethiopian roast product page in the last 7 days." That's maybe 200 people. The campaign spends $2.50/day but gets zero conversions because there's no audience to serve.

**The fix:** Use a tiered audience approach for your first 90 days.

- **Tier 1 (Retargeting):** Target visitors who viewed your product page or added to cart but didn't purchase. This should be 15–20% of your budget.
- **Tier 2 (Category interest):** Target shoppers who browsed or purchased in your broader category (e.g., "coffee equipment" or "specialty coffee"). This gets 40–50% of spend.
- **Tier 3 (In-market):** Target shoppers actively searching for your category keywords in the last 30 days. This gets the remaining 30–40%.

This balanced approach gives you enough volume to test while staying relevant. You can also layer geographic targeting to keep ads local—especially important for brick-and-mortar businesses.

### Mistake #4: Forgetting the Landing Page Experience

A local business spent $4,500 on a three-month Amazon DSP test. Their ad was solid—a clean video showcasing their organic dog treats, targeted at pet owners in Chicago. But when someone clicked, the ad sent them to their Amazon product listing—which had no A+ Content, no reviews beyond seven, and a shipping delay message.

**Result:** A 1.2% click-through rate but a 0.3% conversion rate. The campaign died.

**The reality:** Amazon DSP drives traffic, but your product page sells the product. If your listing is messy, slow, or unconvincing, even the best ad won't rescue it.

**The fix:** Before you spend a dollar on DSP, optimize your Amazon listing:

- **Have at least 15–20 reviews** with a rating above 4.0 stars. Buyers trust social proof.
- **Use A+ Content** (formerly Enhanced Brand Content) to tell a story, show lifestyle images, and highlight benefits—not just features.
- **Ensure inventory is in stock** and shipping is Prime-eligible. Nothing kills a campaign faster than an "out of stock" badge.
- **Check mobile load time.** Over 60% of Amazon traffic comes from mobile. If your listing takes more than 3 seconds to load, you're losing half your clicks.

Your listing is the storefront. The DSP ad is just the street sign. Fix the storefront first.

### Mistake #5: Expecting Results in Two Weeks

Small business owners are used to fast wins. You run a Facebook ad today, you see sales tomorrow. Amazon DSP doesn't work like that.

The platform's learning phase—where the algorithm figures out who to serve your ad to, at what frequency, and on which placements—takes 7–14 days minimum. During that period, performance metrics will be erratic. You might see zero conversions for four days, then a sudden spike. Many business owners see the flat line and kill the campaign before it has a chance to optimize.

**The fix:** Commit to a minimum 60-day test with a clear budget floor. Here's a realistic timeline:

- **Days 1–14:** Learning phase. No major optimizations. Monitor impressions and click-through rate only.
- **Days 15–30:** Early optimization. Adjust bids by placement, pause underperforming audience segments, double down on strong creatives.
- **Days 31–60:** Scale phase. Increase budget on winning combinations. Start testing new audiences or creatives.

Your budget for this test should be at least $2,000–$3,000 total ($1,000–$1,500 per month for two months). Any less, and you won't generate enough data to know what works. Think of the first 60 days as research—not profit. The profit comes in months three through six, once you've found your winning recipe.
