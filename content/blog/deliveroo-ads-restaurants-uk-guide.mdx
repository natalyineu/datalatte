...
You’ve set up your Deliveroo ads, allocated a budget, and waited for the orders to roll in. But three weeks later, you’re spending £47 a day and seeing only one or two extra orders. Your cost-per-click is climbing, and your return on ad spend looks more like a leaky tap than a steady pour.

You are not alone. After working with dozens of restaurant owners across the UK, we’ve seen the same patterns repeat. Here are the five most costly mistakes small kitchens make with Deliveroo ads — and the specific fixes that turned campaigns around.

### Mistake #1: Blasting Your Budget to the Whole City

**The mistake:** A new pizzeria in Spitalfields set their delivery radius to 8 kilometres because they assumed bigger reach meant more orders. Within two weeks, they had blown through £320 with only six orders — all from beyond 5 kilometres, where delivery times exceeded 45 minutes and food arrived cold. Their average rating dropped from 4.5 to 3.8 because of late, soggy deliveries.

**Why it hurts:** Deliveroo’s algorithm penalises restaurants with high cancellation rates and low completion scores. When you target customers too far away, you increase the likelihood of late deliveries, cancelled orders, and negative reviews. That feedback loop drags down your visibility even for nearby customers.

**The fix:** Start with a 1.5-mile radius for dense urban areas (London, Manchester, Birmingham) and 3 miles for suburban locations. Use Deliveroo’s heatmap tool to see where your existing orders actually come from. One café owner in Bristol discovered that 82% of their repeat orders originated within a 0.8-mile radius. They narrowed their campaign to that zone, lowered their cost-per-click from £1.20 to £0.45, and saw a 34% increase in order frequency within three weeks.

**Actionable step:** Export your last 90 days of Deliveroo order data. Plot the postcodes on a map. Set your ad radius to cover only the postcodes where at least 70% of your orders already come from. Then expand by 0.5 miles only after you see consistent 4.5+ ratings in that core zone.

### Mistake #2: Forgetting to Pause Low-Performing Menu Items

**The mistake:** A curry house in Birmingham promoted their entire menu through Deliveroo ads — all 47 items. Their most expensive dish, a £22 lamb shank special, was getting 80% of the ad clicks but only converting to orders 3% of the time. Customers would see the glossy photo, click, then abandon when they realised the price didn’t include rice or naan. Meanwhile, their £9.50 chicken tikka masala — a high-margin, fast-to-prepare item — was buried on page three of the menu.

**Why it hurts:** Deliveroo charges you per click, not per order. If you’re paying for clicks on dishes that rarely convert, you’re funding Deliveroo’s profits while starving your own. Worse, the platform’s algorithm notices that your ad clicks don’t lead to orders and reduces your overall campaign quality score, increasing your cost-per-click across all items.

**The fix:** Run a “menu audit” every seven days. Identify your top three menu items by profit margin, preparation speed, and customer rating. Only promote those through ads. A fish-and-chip shop in Brighton tested this approach: they paused ads for their £15.50 mixed grill (low margin, high prep time) and doubled down on their £8.95 cod and chips. Their conversion rate jumped from 8% to 22%, and their average ad spend dropped from £5.12 per order to £1.89.

**Actionable step:** Create a spreadsheet with four columns for each menu item: cost-per-click, conversion rate, profit margin, and preparation time. Pause any item where the conversion rate is below 5% *or* the profit margin is below 40%. Keep only the items that score high on at least three of the four metrics.

### Mistake #3: Setting and Forgetting Your Ads (The “Static Campaign” Trap)

**The mistake:** A sandwich shop in Manchester set up their Deliveroo ad campaign in January and didn’t touch it until June. By March, their cost-per-click had doubled from £0.80 to £1.60. Their orders were flat, but they were paying more for the same results. The problem? They were still targeting customers searching for “warm soup” in June — when nobody in Manchester wants soup.

**Why it hurts:** Deliveroo’s ad auction is dynamic. Competitors enter and leave the market, customer search behaviour shifts with seasons and weather, and your own restaurant’s performance changes. A static campaign ignores all these signals. Your ads might be showing for search terms that no longer convert, or bidding against competitors who have slashed their prices during a slow period.

**The fix:** Schedule a 15-minute campaign review every Tuesday and Thursday. Tweak three things: bid amounts (lower on rainy days when demand is higher naturally, raise on sunny days when people might grill instead of order), targeting times (boost during 11:00–13:00 for weekday lunch crowds), and promoted items (swap out summer salads for warm bowls when the temperature drops below 12°C). A London ramen bar that made these micro-adjustments twice a week reduced their cost-per-order from £4.30 to £2.10 over six weeks.

**Actionable step:** Set phone alarms for Tuesday at 10 AM and Thursday at 3 PM. During each check-in, look at three numbers: your cost-per-click for the last 48 hours, the conversion rate of your top promoted item, and the weather forecast for the next three days. If any number has moved more than 15% from your baseline, make one adjustment — lower your bid by 20% if CPC is climbing, or swap a promoted item if conversion dropped.

### Mistake #4: Ignoring Star Ratings and Review Velocity

**The mistake:** A Thai restaurant in Leeds was spending £18 per day on Deliveroo ads but had a 3.2-star rating. Their ad click-through rate was decent — 4.1% — but their order conversion rate was abysmal at 2.3%. Customers clicked on the ad, saw the rating, and left. The owner didn’t realise that Deliveroo’s algorithm gives preferential placement to restaurants with 4.2 stars or higher, meaning his ads were shown less frequently even though he was paying the same bid.

**Why it hurts:** This is a double penalty. First, low ratings scare off potential customers who click your ad. Second, Deliveroo’s quality score system reduces your ad visibility — you pay more for worse placement. A restaurant with a 4.5-star rating and a £0.80 bid might appear above a 3.5-star restaurant bidding £1.20.

**The fix:** Before you spend another pound on ads, invest two weeks in reputation repair. Reply to every negative review with a specific apology and an offer (a free side on next order). Run a “review incentive” programme — include a handwritten note in every delivery asking satisfied customers to leave a rating. One Italian restaurant in Edinburgh went from 3.8 stars to 4.5 stars in 19 days by sending personalised follow-up messages through Deliveroo’s messaging system to every customer who rated them 4 or 5 stars, simply asking them to share their experience publicly. Their cost-per-order dropped by 58% after the rating improvement.

**Actionable step:** Calculate your “rating gap” — subtract your current star rating from 4.5. For every 0.1 point below 4.5, expect to pay approximately 12% more for the same ad placement. If you’re at 3.8, you’re overpaying by roughly 84%. Fix the rating first. Then allocate ad budget.

### Mistake #5: Overlooking Peak-Time bidding Strategy

**The mistake:** A burger joint in Glasgow ran the same bid (£1.10 per click) from 8 AM to 11 PM every day. But between 5 PM and 7 PM — dinner rush — their competitors were bidding £1.80 to £2.20 for the same keywords. The burger joint’s ads were pushed to the bottom of page two during the most profitable hours. Meanwhile, their ads for breakfast items were running at 10 PM, when nobody is ordering sausage rolls.

**Why it hurts:** Deliveroo’s ad auction is time-sensitive. During peak hours (typically 11:30–13:30 for lunch, 17:30–19:30 for dinner, and 21:30–23:00 for late-night cravings), competition spikes. If you bid the same amount across all hours, you win placements during low-traffic times and lose during high-traffic times — exactly backwards from what you want.

**The fix:** Create three time-based bid adjustments. For peak hours (the 1.5-hour windows around typical meal times), increase your bid by 40% to 60%. For shoulder hours (14:00–17:00 and 20:00–21:30), keep your bid at baseline. For dead hours (after 23:00, before 10:00 for lunch-focused restaurants), reduce your bid by 50% or pause ads entirely. A burrito spot in Birmingham that implemented this saw their ad spend shift from 70% wasted impressions to 85% high-intent impressions. Their orders during peak hours increased by 43% while total ad spend only rose by 12%.

**Actionable step:** Look at your Deliveroo order history and identify your peak 4-hour window — the block of time where you receive the most orders. Set your highest bid for that window. For every hour outside that window, reduce bids by at least 30%. If you don’t serve breakfast, pause ads before 10 AM.
