...
<StatRow
  values="25%|12%|6%|4%"
  labels="Businesses that show prices on their website see a 25% increase in bookings, while those that don't see a 12% decrease. Average price transparency increases conversion rates by 6%, and 4% more customers opt for higher-priced services."
  subs="According to a study, 75% of consumers prefer to buy from businesses that display their prices clearly."
