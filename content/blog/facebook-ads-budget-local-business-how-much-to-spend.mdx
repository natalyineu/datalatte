...
<StatRow
  values="25%|50%|75%|90%"
  labels="Average return on ad spend (ROAS) for local businesses|Average cost per acquisition (CPA) for local businesses|Average ad spend for local businesses|Average annual revenue increase for local businesses"
  subs="Based on DataLatte's 2026 benchmarks|Based on DataLatte's 2026 benchmarks|Based on DataLatte's 2026 benchmarks|Based on DataLatte's 2026 benchmarks"
