...
<CompareBar
  ...
  items="Send newsletters to opt-in subscribers|Email existing customers about similar products|Send promotional emails to purchased lists|Use pre-ticked opt-in boxes|Re-engage lapsed subscribers with a single opt-in prompt|Share your email list with a partner business"
  valuesA="100|80|0|0|60|0"
  valuesB="0|20|100|100|40|100"
  labelA="Compliant ✓"
  labelB="Not compliant ✗"
  highlightIndex="0"
/>
