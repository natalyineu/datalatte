...
<StepPlan
  steps="Set up your "filming corner" — the spot in your salon with the best natural light|Film every interesting transformation (with client consent — verbal is fine, document in your booking notes)|Film in portrait (vertical, 9:16) format — never horizontal on TikTok|Aim for 3 posts per week minimum; 5 is better for initial growth|Spend 20 minutes per week watching your competitors' and trending salon content on TikTok — steal formats, not content|Respond to every comment in the first hour of posting — early engagement dramatically boosts algorithm reach|Post between 6–9pm for UK audiences; 5–8pm for continental Europe — these are peak scroll times"
  title="Getting Started on TikTok for Salon Owners"
/>
