...
<StatRow values="25%|35%|50%|65%" labels="Pet Groomers Using Email Marketing|Increase in Bookings with Email Marketing|Average Return on Investment (ROI)|Pet Groomers Using Mailchimp" subs="Pet owners expect regular reminders, offers, and updates|Pet owners expect regular reminders, offers, and updates|Pet owners expect regular reminders, offers, and updates|Pet owners expect regular reminders, offers, and updates" trends="up|neutral|up|up" />
...
If you want to set this up and don't want to spend four hours figuring out which segment tags to use or how to connect your booking system, [book a free consultation](/free-audit). I'll tell you exactly what I'd do in your specific situation, and I won't use the words "growth hack" once.
