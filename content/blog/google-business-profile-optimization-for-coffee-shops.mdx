...
<StatRow values="72%|40%|25%|15%" labels="Consumers use online reviews for trust|Coffee shops with complete GBP listings get 40% more reviews|GBP optimization boosts website traffic by 25%|GBP completion rate for coffee shops is only 15%" subs="of consumers|of consumers|of consumers|of consumers" trends="up|up|up|down"/>
