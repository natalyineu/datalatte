...
<StatRow
  ...
  subs="According to our research, 30% of fitness studios already use email marketing, but only 50% have seen a significant increase in sales. Meanwhile, 20% of studios are already leveraging AI-powered email, and 15% are considering it for future use.|According to our research, 30% of fitness studios already use email marketing, but only 50% have seen a significant increase in sales. Meanwhile, 20% of studios are already leveraging AI-powered email, and 15% are considering it for future use.|According to our research, 30% of fitness studios already use email marketing, but only 50% have seen a significant increase in sales. Meanwhile, 20% of studios are already leveraging AI-powered email, and 15% are considering it for future use.|According to our research, 30% of fitness studios already use email marketing, but only 50% have seen a significant increase in sales. Meanwhile, 20% of studios are already leveraging AI-powered email, and 15% are considering it for future use."
