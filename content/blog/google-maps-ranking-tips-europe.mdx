...
<CompareBar
  ...
  items="Hair Salon vs. Beauty Salon (for hair-only business)|Coffee Shop vs. Café|Yoga Studio vs. Fitness Center|Italian Restaurant vs. Restaurant"
  valuesA="100|95|98|97"
  valuesB="62|71|54|58"
  labelA="Correct specific category (relative visibility)"
  labelB="Generic substitute (relative visibility)"
  highlightIndex="0"
/>
...
<LineChart
  title="Review Volume vs. Local Ranking Position — European Service Businesses"
  labels="0-10 reviews|11-25 reviews|26-50 reviews|51-100 reviews|101-200 reviews"
  datasets="[{label:'Avg Map Pack position',values:'8.2|5.4|3.1|2.0|1.4'},{label:'Weekly profile views',values:'45|120|280|510|820'}]"
  caption="DataLatte analysis across 140 European local service business GBP profiles, 2025. Position 1 = best."
  yAxisLabel="Position / Views"
/>
