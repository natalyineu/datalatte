...
<StatRow
  values="72%|57%|43%|25%"
  labels="Coffee shops with complete GMB profiles|Coffee shops with complete GMB profiles|Coffee shops with complete GMB profiles|Coffee shops with complete GMB profiles"
  subs="Receive an average of 72% more views, 57% more calls, and 43% more website visits|Receive an average of 72% more views, 57% more calls, and 43% more website visits|Receive an average of 72% more views, 57% more calls, and 43% more website visits|Receive an average of 72% more views, 57% more calls, and 43% more website visits"
