...
Even the most well-intentioned email marketing campaigns can fall flat if you trip over common pitfalls. Local business owners often wear too many hats, and it’s easy to overlook the small details that make a big difference. Below are five mistakes I see again and again—along with specific fixes that have helped our clients turn things around.

### Mistake #1: Sending Emails on a Whim (or Not at All)

One coffee shop owner I worked with in Melbourne sent emails only when they had a new seasonal drink—about once every three months. On the other end of the spectrum, a pet groomer in Austin blasted their list every single day with the same “20% off” offer. Both approaches hurt engagement. The first meant customers forgot the brand existed; the second drove unsubscribe rates through the roof.

**The fix:** Establish a consistent, data-backed cadence. For most local businesses, a weekly or bi-weekly schedule works best. Test and adjust based on your audience’s behavior. For example, a hair salon might send a bi-weekly newsletter with tips, plus a monthly promotion. Use your email platform’s analytics to see when open rates dip—that’s your signal to reduce frequency. A fitness studio in London we work with found that sending one email on Tuesday morning and another on Thursday afternoon (with a weekend class reminder) increased their class bookings by 34% without annoying subscribers.

**Actionable step:** Choose a day and time that aligns with your customers’ habits. If you’re a coffee shop, early morning (6–7 AM) might work. If you’re a pet groomer, mid-week afternoons when owners are planning weekend appointments could be ideal. Stick to that schedule for at least 4 weeks, then review open and click rates.

### Mistake #2: Ignoring Mobile Optimization

More than 60% of emails are opened on mobile devices. Yet I still see beautiful desktop-designed emails that look like a tangled mess on a smartphone. Tiny fonts, images that don’t resize, and CTAs that require a magnifying glass to tap. A local bakery in Vancouver lost a full weekend of pre-orders because their “Order Now” button was too small to click on an iPhone.

**The fix:** Design mobile-first. Use a responsive email template (most platforms like Mailchimp, Klaviyo, or Constant Contact offer these). Keep subject lines under 40 characters so they don’t get cut off. Use a single-column layout, large fonts (at least 14px for body text), and buttons that are at least 44×44 pixels. Preview your email on at least two devices before sending. Also, avoid heavy images—load times on mobile data can cause readers to bounce.

**Actionable step:** Run a test: send your next campaign to yourself and a few team members. Open it on an iPhone, an Android, and a desktop. If you have to pinch-zoom to read the text, go back and redesign. We helped a pet supply store in Sydney redesign their mobile layout, and their click-to-open rate jumped from 12% to 21% in one month.

### Mistake #3: Sending the Same Email to Everyone

This is the cardinal sin of email marketing. A local gym in Chicago sent a single newsletter to their entire list—including both active members and people who hadn’t visited in two years. The active members got annoyed by offers for “new member discounts,” and the lapsed ones felt forgotten. The result? A 9% unsubscribe rate in one send.

**The fix:** Segment your list based on behavior, preferences, and lifecycle stage. Even simple segmentation helps. For example:
- **New subscribers:** Send a welcome series with a discount code.
- **Active customers (purchased within 90 days):** Send loyalty rewards, event invites, or upselling opportunities.
- **Lapsed customers (no purchase in 6+ months):** Send a re-engagement campaign with a strong offer or a “We miss you” message.
- **Location-based:** If you have multiple locations (e.g., a chain of hair salons), segment by city or neighborhood.

**Actionable step:** Start with just two segments: “Active” and “Inactive.” Create a different email for each. For example, a coffee shop could send active customers a “Buy 5 coffees, get 1 free” card, while inactive ones get a “Come back and try our new latte—first one’s on us.” Track the difference in open and conversion rates. One of our clients, a pet groomer in Toronto, segmented by pet type (dog vs. cat) and saw a 45% increase in click-through rates on breed-specific grooming tips.

### Mistake #4: Writing Weak or Spammy Subject Lines

Subject lines are the gatekeepers of your email. A boring line like “March Newsletter” gets ignored. A spammy line like “FREE MONEY!!!” triggers spam filters and erodes trust. A local bookshop in Portland used “New titles this week” for months and saw open rates below 15%. Meanwhile, a competitor used “The book that made me cry (and why you need it)” and hit 38% open rates.

**The fix:** Use curiosity, personalization, and value. Keep it under 60 characters. Avoid all caps, excessive exclamation marks, and words like “free,” “guaranteed,” or “act now” (they trigger spam filters). Instead, try:
- **Personalization:** “Sarah, your favorite roast is back in stock”
- **Urgency + value:** “Last chance: 20% off grooming ends Friday”
- **Curiosity:** “The one stretch that relieves back pain (in 2 minutes)”
- **Benefit-driven:** “How to keep your dog’s coat shiny this winter”

**Actionable step:** A/B test two subject lines on a small segment (10–20% of your list) before sending to everyone. Use your email platform’s built-in testing tool. For example, a fitness studio could test “New class: Yoga for runners” vs. “Run faster, recover smarter with our new yoga class.” The winner gets sent to the rest. We’ve seen clients improve open rates by 10–15% with just one round of testing.

### Mistake #5: Not Tracking or Testing Anything

I once worked with a hair salon owner who had been sending emails for two years but had never looked at a single report. She had no idea what her open rate was, which links got clicked, or whether any revenue came from those emails. She was essentially shouting into the void.

**The fix:** Set up tracking from day one. Most email platforms provide open rates, click-through rates, bounce rates, and unsubscribe rates. But go deeper: track conversions (purchases, bookings, sign-ups) using UTM parameters or integration with your booking system. Also, A/B test one element per campaign—subject line, CTA button color, offer type, or send time. Don’t test everything at once; you won’t know what caused the change.

**Actionable step:** Pick one metric to improve this month. For example, if your open rate is below 20%, focus on subject lines. If your click rate is below 2%, focus on your CTA and content layout. Use a simple spreadsheet to record your tests and results. A pet groomer in Brisbane tested two CTAs: “Book now” vs. “Give your pup a spa day.” The second one increased clicks by 27%. That small change, tracked and repeated, added an estimated $1,200 in monthly revenue.
