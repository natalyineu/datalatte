...
<CompareBar
  ...
  items="UK|Germany|France|Netherlands|Spain|Italy|Ireland"
  valuesA="8.90|6.20|5.80|7.10|4.30|4.80|7.60"
  valuesB="4.20|3.10|2.90|3.60|2.10|2.40|3.80"
  labelA="CPM in £/€ (cost per 1,000 impressions)"
  labelB="Avg CPL £/€ (cost per lead)"
  highlightIndex="0"
/>
...
<LineChart
  title="Typical ROI Improvement Curve — UK Local Business Google Ads"
  labels="Month 1|Month 2|Month 3|Month 4|Month 5|Month 6"
  datasets="[{label:'Cost per customer (£)',values:'180|140|95|75|65|58'},{label:'Customers per month',values:'2|4|6|9|12|15'}]"
  caption="Illustrative improvement trajectory for a UK local service business with £400/month Google Ads budget and active optimisation."
