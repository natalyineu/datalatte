...
<StatRow
  values="85%|62%|45%|30%"
  labels="Small businesses with a strong online presence grow 85% faster than those without|Small businesses with a strong online presence grow 85% faster than those without|Small businesses with a strong online presence grow 85% faster than those without|Small businesses with a strong online presence grow 85% faster than those without"
  subs="62% of customers use search engines to find local businesses|62% of customers use search engines to find local businesses|62% of customers use search engines to find local businesses|62% of customers use search engines to find local businesses"
  trends="45% of local searches on mobile devices lead to action within 24 hours|45% of local searches on mobile devices lead to action within 24 hours|45% of local searches on mobile devices lead to action within 24 hours|45% of local searches on mobile devices lead to action within 24 hours"
/>
...
*   **[DataLatte Local SEO Grader](/tools/local-seo-grader):** Free, instant, no email required — a good first stop to see which local SEO factors (including keyword targeting) need work before you invest in a paid research tool.
...
[Get in touch with DataLatte today for a free audit and let's work together to drive more customers to your doorstep](/free-audit)!
