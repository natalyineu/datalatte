...
<StatRow values="60%|70%|80%|90%" labels="Small businesses without tracking | Businesses with basic tracking | Businesses with basic analytics | Businesses with advanced analytics" subs="Source: Google, HubSpot" trends="down|up|up|up"/>
