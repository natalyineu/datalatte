...
<CompareBar
  ...
  items="Star rating + review count|Professional photography|Physical address visible|Years in business|Named team members|Insurance/certification badges|Press mentions|Security/SSL badge"
  valuesA="9.2|7.8|8.9|7.1|8.4|7.6|6.9|5.8"
  valuesB="2.1|3.4|1.8|2.9|1.9|2.4|3.2|1.2"
  labelA="Conversion impact (0-10)"
  labelB="% of EU SME sites that include this element"
  highlightIndex="0"
/>
