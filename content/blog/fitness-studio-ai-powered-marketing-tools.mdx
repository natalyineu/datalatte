...
<StatRow values="80%|50%|30%|20%" labels="Fitness studios using AI-powered marketing|Fitness studios using AI-powered marketing|Fitness studios using AI-powered marketing|Fitness studios using AI-powered marketing" subs="in the next year|already using AI marketing tools|considering AI marketing tools|don't know about AI marketing tools" trends="up|up|neutral|down"/>
...
[Book a free consultation with our team](/free-audit) and let's turn your studio's marketing into your strongest growth engine.
