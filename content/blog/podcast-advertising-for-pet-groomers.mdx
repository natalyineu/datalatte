...
### Mistake 1: Running a National Podcast Ad When You Only Serve One City

**The story:** A groomer in Austin, Texas — let's call her shop "The Austin Dog House" — spent $1,200 on a month-long sponsorship of a popular national pet wellness podcast. The host read a lovely 60-second spot about their mobile grooming van. Downloads looked great: roughly 18,000 listens that month. The problem? Fewer than 3% of those listeners lived within driving distance of Austin. The shop got exactly one new client from that spend. Cost per acquisition: $1,200. The owner told me she "felt sick looking at her bank statement."

**What went wrong:** She picked a show with massive reach but zero geographic targeting. National podcast networks sell reach. Local businesses need relevance.

**The fix:** She canceled the national placement and ran a host-read ad on *Austin Pets Podcast* (a local show with about 4,000 downloads per episode). Same host-read ad format, but the audience was 85% within the Austin metro area. She also asked the host to mention her shop by the specific neighborhood cross streets — "over by South Congress and Oltorf" — which made it feel hyper-local.

**The outcome:** $500/month on the local podcast. Tracked via a unique promo code ("AUSTINDOG20" for 20% off first groom). Over three months, she logged 42 new clients who mentioned the code, with an average first-visit revenue of $85 each. That's $3,570 in revenue from $1,500 in ad spend. She also kept 19 of those clients for recurring monthly grooms. Cost per acquisition dropped from $1,200 to roughly $36.

### Mistake 2: Using a Generic Promo Code That Gets Leaked to Coupon Sites

**The story:** A groomer in Chicago — "Paws on Clark" in Lincoln Park — ran ads on three local lifestyle podcasts. Smart move. But she used "GROOM10" as her promo code across all three. Within two weeks, that code showed up on RetailMeNot and a local coupon-sharing Facebook group. People who had never heard the podcast were using the code. She couldn't tell which podcast drove the booking, and she was giving discounts to people who would have paid full price anyway.

**What went wrong:** One code for multiple channels is a tracking disaster. You lose attribution, and you leak margin to people who didn't convert from the ad.

**The fix:** She created unique codes per podcast: "NORTHSIDE10" for the Lincoln Park neighborhood show, "WRIGLEY10" for the Cubs-adjacent podcast, and "LAKEFRONT10" for the general Chicago lifestyle show. She also set the code expiration to 30 days post-episode air date. And she trained her front desk staff to ask every client, "How did you hear about us?" — logged in Square Appointments as a custom field.

**The outcome:** Within 60 days, she knew exactly that the Lincoln Park neighborhood podcast (which cost $350/month) drove 22 bookings, the Cubs podcast ($400/month) drove 8, and the general lifestyle show ($300/month) drove 3. She cut the lifestyle show, kept the other two, and saved $300/month. Her average cost per booked appointment dropped from $47 to $24. And she stopped leaking discount codes to people who would've paid full price — recapturing roughly $200/month in margin.

### Mistake 3: Letting the Host Read a Script You Wrote (Instead of Letting Them Talk)

**The story:** A groomer in Nashville — "Bark & Birch" in East Nashville — paid $500 for a host-read ad on a popular local morning show podcast. She wrote a dense, 90-second script that listed every service: "full groom, bath and brush, nail trim, teeth brushing, de-shedding treatment, anal gland expression..." It sounded like a menu read over the PA system at a DMV. The host read it dutifully, but flat. After three weeks: zero tracked conversions.

**What went wrong:** The host's superpower is their natural, conversational rapport with their audience. Handing them a script that sounds like a brochure kills that trust. Podcast listeners can smell inauthenticity from three blocks away.

**The fix:** She rewrote the approach entirely. Instead of a script, she sent the host three bullet points:
- "I'm the owner of Bark & Birch in East Nashville. We specialize in nervous dogs — the ones who hate the dryers and shake at the nail clippers."
- "We do a 'slow groom' process. It takes longer, but the dogs actually wag their tails when they leave."
- "First visit is 15% off if you mention the podcast."

She told the host: "Just talk about us like you would if I were sitting next to you at a bar."

**The outcome:** The host ad-libbed for about 75 seconds, told a story about her own anxious golden retriever, and made the shop sound like a sanctuary instead of a service menu. In the next 30 days, 18 new clients booked, citing the podcast. The shop made $2,160 in first-visit revenue on a $500 ad spend. The owner's takeaway: "I paid for the host's voice, not my script. I should have trusted that from the start."

---

## How to Track Podcast Ad Performance Using the Tools You Already Own

Most podcast ad guides tell you to "just use a promo code and trust your gut." That's bad advice if you want to know whether your $500 went into a hole or came back with friends.

Here's the setup I recommend for grooming businesses, using tools you probably already have:

**Step 1: Create unique landing pages or booking links per podcast**

If you use **Booksy** or **Square Appointments**, create a dedicated booking link for each podcast. For example:
- `squareup.com/appointments/book/podcast-austin`
- `squareup.com/appointments/book/podcast-cubs`

This takes five minutes per link. Now you can see exactly which link generated the booking, even if nobody remembers a promo code.

A Denver groomer using this method found that one podcast's link generated 14 bookings, while another generated 2 — despite both having similar listener numbers. She cut the weak one and doubled down on the strong one. Monthly spend stayed the same ($800), but bookings increased by 40%.

**Step 2: Set up a Google Voice number per podcast**

**Google Voice** is free. Get a number for each podcast you advertise on. Route all calls to your shop's main line, but you can see which number rang. A groomer in Portland used three Google Voice numbers across three podcasts. Two weeks of data showed one podcast drove 11 calls, another drove 4, and the third drove 0. She cut the zero-performer and saved $350/month.

**Step 3: Add a custom question in your booking software**

If you use **Booksy**, **Square Appointments**, or **Vagaro**, add a required field at checkout: "How did you hear about us?" with options like "Podcast — [Podcast Name]" plus "Google Search," "Yelp," "Friend," "Walk-in."

This sounds obvious, but most groomers skip it because they think clients won't fill it out. They will if you keep it simple. One shop in Phoenix trained their front desk to say, "Just checking — was it our ad on the Phoenix Dog Mom podcast or something else?" Their tracking accuracy went from "vague guesses" to 92% attribution in 30 days.

**Step 4: Cross-reference with Google Analytics**

If your website has **Google Analytics** or **Google Search Console**, you can see if branded search spikes after a podcast episode airs. A client in Minneapolis ran a podcast ad on a Tuesday. On Wednesday, searches for "[Shop Name] grooming" jumped 300% compared to the previous Wednesday. That's a proxy signal that the ad worked — even if the promo code didn't get used. Track it in a simple spreadsheet. After three months, you'll know which podcasts drive the most search interest, even from listeners who didn't book immediately.

---

## Pairing Podcast Ads with Google Ads for Compound Results

Here's something most guides skip: podcast ads and search ads work better together than either does alone.

Here's why. A podcast listener hears your ad, likes what they hear, but doesn't call right away. They're driving, walking the dog, making dinner. Later that night, they search your shop name on Google. If you don't have a **Google Ads** campaign for your branded search terms, they might click on a competitor who's running ads on your name. Yes, that happens. I've seen it at three different clients.

**The fix:** Run a small Google Ads campaign targeting your business name plus keywords like "[business name] grooming" and "[business name] appointments." Budget: $100–$200/month. This costs very little because branded search has low competition and high intent. The podcast ad plants the seed. The search ad catches the person when they're ready to convert.

A groomer in Kansas City — "Barkingham Palace" in the Waldo neighborhood — ran this exact combo. She spent $500/month on a local pet podcast (host-read, 60-second spot) and $150/month on Google Ads for branded search terms. The podcast drove awareness. The Google Ads caught the 40% of listeners who searched her name later. Over three months, she tracked 67 new client bookings, with an average first-visit spend of $92. Total ad spend: $1,950. Revenue from new clients: $6,164. Lifetime value of retained clients (she kept 31): estimated $18,600 over the next year.

Google Ads alone would have cost more per click because she had no brand awareness. Podcast alone would have lost the people who delayed their decision. Together, they closed the loop.
