...
<Callout type="tip" title="When to Use Each Campaign Type"> New to Google Ads? Start with Performance Max to get results quickly with less setup. Have 3+ months of conversion data? Add Standard campaigns to test and refine specific keywords and audiences that PMax may be missing.</Callout>
