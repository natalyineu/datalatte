...
Even the most promising Facebook Lookalike Audiences can fall flat if you’re tripping over common pitfalls. After helping hundreds of local coffee roasters, pet groomers, and fitness studios set up these campaigns, I’ve seen the same mistakes repeat themselves. Here are five of the biggest ones—and how to fix them before your ad budget goes up in steam like a burnt espresso shot.

### Mistake #1: Using a Source Audience That’s Too Small

One of the most frequent errors is creating a Lookalike from a custom audience with fewer than 100 people. A local hair salon in Austin once tried to build a 1% Lookalike from just 42 email subscribers. The result? Facebook’s algorithm had barely any data to learn from—so the audience was essentially random. Their cost-per-lead skyrocketed to $87, compared to the $18 they’d seen with a properly sized seed.

**The fix:** Aim for a minimum of 500 people in your source audience, though 1,000–5,000 is ideal. That’s enough for Facebook to detect meaningful patterns. If you haven’t collected that many emails yet, combine data sources: email subscribers, website visitors (from the Facebook pixel), and past purchasers. A local bakery can merge its loyalty card signups (200 people) with its blog subscribers (300) and one-time online orders (150) to hit that 650 threshold.

### Mistake #2: Never Refreshing Your Lookalike Audience

Lookalikes aren’t “set and forget.” Customer behavior changes, seasons shift, and your best customers today might not be your best customers in six months. A pet groomer in Melbourne created a Lookalike from her top clients in January, and by July the audience was pulling in people who had moved away or whose pets had passed away. Her ad engagement dropped by 40%.

**The fix:** Rebuild your Lookalike every 30–60 days. Use “retention” as your trigger: for example, every month, pull a fresh custom audience of customers who made a purchase in the last 90 days, then generate a new Lookalike from that. If you use a CRM like Mailchimp or HubSpot, set a recurring report to export your active customer list. The few minutes it takes will save you from serving ads to people who haven’t stepped foot in your store in a year.

### Mistake #3: Going Too Broad with the Lookalike Percentage

I get it—wider Lookalikes (5%, 10%, even 20%) seem appealing because they include millions of people. But for local businesses, that often means targeting folks who share only the loosest connection to your best customers. A coffee shop in Denver chose a 10% Lookalike and ended up reaching college students who had never bought specialty brew, resulting in a 2.1% click-through rate and zero conversions.

**The fix:** Start with a 1% Lookalike—the top 1% of people most similar to your source audience. This gives you a highly concentrated group that mirrors your loyalists. Once you’ve validated that this small audience converts well (e.g., cost-per-acquisition under $15), you can test a 2–3% Lookalike to expand reach without sacrificing too much quality. For most local businesses, staying within 1–3% yields the sweet spot between scale and relevance.

### Mistake #4: Ignoring Customer Lifetime Value in the Seed Audience

Many business owners simply throw their entire customer list into a Lookalike. But that lumps together a one-time buyer who used a 50%-off coupon with a VIP who visits every week. The Lookalike algorithm treats them equally, diluting the quality. A fitness studio in Vancouver once used all 1,200 past attendees (including free trial drop-ins) as their seed. Their Lookalike was filled with people who lacked loyalty—cost-per-membership was $94, three times the average.

**The fix:** Segment your customers by lifetime value (LTV). Create a separate custom audience of only your top 20% of buyers—those who have spent the most, visited the most, or referred the most friends. Use that high-LTV segment as your Lookalike source. For example, a dog groomer can filter for clients who have booked at least five appointments in the last year. That precision makes Facebook’s algorithm work harder for you. One study we ran across multiple local clients showed that switching to an LTV-based Lookalike lowered cost-per-lead by an average of 34%.

### Mistake #5: Not Excluding Existing Customers from the Lookalike

This one seems obvious, but it happens constantly. You run a Lookalike campaign, and your ad shows up to people who already bought from you—but because they’re in the Lookalike (which is based on similarity, not exclusion), they see a “new customer” offer. That not only wastes ad spend but also annoys loyal patrons. A hair salon in London reported that 22% of their Lookalike ad clicks came from existing clients who were confused about the promotion.

**The fix:** Always add an exclusion layer. When you create your ad set, in the “Audience” section, select “Exclude” and choose your custom audience of past purchasers. If you also want to avoid current email subscribers who haven’t purchased yet, exclude them too—they’re already in your funnel. This single step can reduce wasted impressions by 15–25% and keep your messaging fresh for the people who truly need to discover you.
