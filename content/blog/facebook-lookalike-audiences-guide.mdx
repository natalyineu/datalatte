...
<BarChart
  ...
  values="85|10|5"
  unit="%"
  caption="Studies show that Facebook lookalike audiences are more cost-effective than traditional marketing method## How to Build a High-Quality Source Audience from Local Business Data
